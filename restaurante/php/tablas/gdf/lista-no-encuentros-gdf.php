...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><i class="fa fa-table"></i> Lista de no encuentros</div>
				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							$sql_query = "SELECT * FROM gdf where encuentro= 'Pendiente' and usuario='$iduser' and eliminado ='1' ";
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="escuentro" id="encuentroVer" class="form-control">
						</div>
					</div>
