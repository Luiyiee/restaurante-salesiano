...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><i class="fa fa-table"></i> En escuela de lideres</div>
				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							$sql_query = "SELECT * FROM gdf where encuentro= 'Encuentro' and escuela_lideres='Proceso' and usuario='$iduser' and eliminado ='1' ";
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<select name="encuentro" id="encuentroVer" class="form-control">
								<option value="Si_E">Si</option>
							</select>
