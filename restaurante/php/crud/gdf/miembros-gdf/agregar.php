...
if (preg_replace("/^[0-9]{10}+$/", '', $telefono)) {
    ...
    $sql = "INSERT into gdf 
    (nombres,apellidos,edad,telefono,sexo,c_r,
    consolidado,encuentro,escuela_lideres,bautizado,asistencia,fecha,usuario,eliminado)
    values
    ('$nombres','$apellidos','$edad','$telefono','$sexo','$c_r',
    'Pendiente','Pendiente','Pendiente','No','Si',now(),'$iduser','1')";
