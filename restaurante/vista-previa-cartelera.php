...
<head>
  ...
  <title>Vista previa cartelera</title>
  <!--favicon-->
...
<body class="bg-theme bg-theme1">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#card').load('php/vista-previa/administrador/vista-previa-cartelera.php');
  ...
  <script type="text/javascript">
    function preguntarSiNo(id) {
      alertify.confirm('Eliminar Datos', 'Una vez eliminado se perderan los datos<br>¿Esta seguro de eliminar este registro?',
        function() {
          eliminarDatos(id)
        }
    ...
    function eliminarDatos(id) {
      ...
      $.ajax({
        type: "POST",
        url: "php/crud/administrador/cartelera/borrar.php",
        data: cadena,
        success: function(r) {
          if (r == 1) {
            exito_eliminar();
