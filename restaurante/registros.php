...
<body class="bg-theme bg-theme1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmRegistroU" enctype="multipart/form-data">
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <label>Sexo</label>
                                <div class="input-group mb-3">
                                    <select name="sexo" id="sexou" class="form-control">
                                        <option value="M">Masculino</option>
                                        <option value="F">Femenino</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <label>Email</label>
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control input-sm" id="emailu" name="email">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/administrador/registros.php');
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#btnAgregar').click(function() {
                ...
                $.ajax({
                    url: "php/crud/administrador/registro/agregar.php",
                    type: "post",
                    dataType: "html",
                    data: formData,
                    cache: false,
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/registro/modificar.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
        ...
        function preguntarSiNo(id) {
            alertify.confirm('Asignar tribus', '¿Esta seguro de aignar las tribus ahora?',
                function() {
                    eliminarDatos(id)
                }
        ...
        function eliminarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/tribu/asignar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
        ...
        function Finalizar(id) {
            alertify.confirm('Finalziar Evento', 'Una vez finalizado los participantes dejaran de estar en tribus y los datos seran eliminados',
                function() {
                    finalizarDatos(id)
                }
        ...
        function finalizarDatos(id) {

            cadena = "id=" + id;

            $.ajax({
                type: "POST",
                url: "php/crud/administrador/tribu/finalizar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        Lobibox.notify('success', {
                            ...
                            hideClass: 'zoomOut',
                            width: 600,
                            msg: 'El evento a finalizado y los registros han sido eliminados'
                        });
                        $('#tabla').load('php/tablas/administrador/registros.php');
                    } else {
                        error_eliminar();
