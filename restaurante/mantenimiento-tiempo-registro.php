...
<body class="bg-theme bg-theme1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="frmTiempoRegistro" enctype="multipart/form-data">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmTiempoRegistroU" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/administrador/tiempo-registro.php');
        });
    </script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#btnAgregar').click(function() {
                ...
                var formData = new FormData(document.getElementById("frmTiempoRegistro"));

                $.ajax({
                    url: "php/crud/administrador/tiempo-registro/agregar.php",
                    type: "post",
                    dataType: "html",
                    data: formData,
                    cache: false,
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmTiempoRegistroU"));
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/tiempo-registro/modificar.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
        ...
        function eliminarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/tiempo-registro/eliminar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_eliminar();
